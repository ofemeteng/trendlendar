...
Click [here](https://github.com/ofemeteng/trendlendar/archive/master.zip) then download the .zip file.  Extract the contents of the zip file, then open your terminal, change to the project directory, and:
